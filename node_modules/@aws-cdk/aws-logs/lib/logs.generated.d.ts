...
export declare class CfnDestination extends cdk.CfnResource {
     ...
     */
    static readonly cfnResourceTypeName = "AWS::Logs::Destination";
    /**
...
export declare class CfnLogGroup extends cdk.CfnResource {
     ...
     * The CloudFormation resource type name for this resource class.
     */
    static readonly cfnResourceTypeName = "AWS::Logs::LogGroup";
    /**
     * @cloudformationAttribute Arn
     */
    readonly attrArn: string;
...
export declare class CfnLogStream extends cdk.CfnResource {
     ...
     * The CloudFormation resource type name for this resource class.
     */
    static readonly cfnResourceTypeName = "AWS::Logs::LogStream";
    /**
     * `AWS::Logs::LogStream.LogGroupName`
     * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-logstream.html#cfn-logs-logstream-loggroupname
     */
...
export declare class CfnMetricFilter extends cdk.CfnResource {
     ...
     * The CloudFormation resource type name for this resource class.
     */
    static readonly cfnResourceTypeName = "AWS::Logs::MetricFilter";
    /**
     * `AWS::Logs::MetricFilter.FilterPattern`
     * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-metricfilter.html#cfn-cwl-metricfilter-filterpattern
     */
...
export declare class CfnSubscriptionFilter extends cdk.CfnResource {
     ...
     * The CloudFormation resource type name for this resource class.
     */
    static readonly cfnResourceTypeName = "AWS::Logs::SubscriptionFilter";
    /**
     * `AWS::Logs::SubscriptionFilter.DestinationArn`
     * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-subscriptionfilter.html#cfn-cwl-subscriptionfilter-destinationarn
     */
